...
function SideBar(props: SideBarProps) {
  ...
  const activateLink = () => {
    ...
    console.log("Button class ", document.getElementById("#profileButton"));
    if (pathname === GROUPS) {
      button = document.getElementById("#groupsButton");
  ...
  return (
    <div className="d-flex flex-column vh-100 flex-shrink-0 p-3 text-white bg-dark sidebar-height">
      <ul className="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <Link id="groupsButton" to={GROUPS} className="nav-link text-white">
        ...
        <li>
          <Link id="friendsButton" to="/" className="nav-link text-white">
        ...
        <li>
          <Link id="bookmarksButton" to="#" className="nav-link text-white">
